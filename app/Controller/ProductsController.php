...
class ProductsController extends AppController{
	...
	public function admin_add(){
		...
		$products = $this->Product->find('list', array(
			'conditions' => array('Product.category_id' => 4)
		));
		// debug(1);
		// debug($products);
		// die;
	...
	public function view($id){
		...
		$data = $this->Product->findById($id);
		$childs = $this->Product->find('all', array(
			'conditions' => array('Product.parent_id' => $id)
		));
		...
		$this->set(compact('data', 'title_for_layout', 'meta', 'childs'));
	}
	...
	public function search(){
		...
		$from_body = $this->Product->find('all', array(
		...
		$this->set(compact('search_res', 'title_for_layout','from_body'));
